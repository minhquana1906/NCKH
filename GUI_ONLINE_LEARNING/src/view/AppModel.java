...
public class AppModel extends JFrame {
    ...
    public AppModel() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("GUI_ONLINE_LEARNING/src/icon/Logo/AppLogo.png"));
        ...
        PanelChatBox.setPreferredSize(new Dimension(300, 500)); // Kích thước ban đầu
        ...
        btnSendMessage.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/GUI_ONLINE_LEARNING/src/icon/Function/send_msg.png"));
        ...
        label_sml.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/user_webcam.png"));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            label.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/user_webcam.png"));
        ...
        btnMicro_On.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/mic-on.png"));
        ...
        btnMicro_Off.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/mic-off.png"));
        ...
        btnCamera_On.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/cam-onn.png"));
        ...
        btnCamera_Off.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/cam-off.png"));
        ...
        btnPresent.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/present-24px.png"));
        ...
        btnOption.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/option.png"));
        ...
        btnEnd = new MyButton();
        btnEnd.setRadius(40);
        btnEnd.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/phone-call-end-white.png"));
        ...
        btnMembers.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/members.png"));
        ...
        btnChat.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/chat.png"));
        ...
        btnSetting.setIcon(new ImageIcon("GUI_ONLINE_LEARNING/src/icon/Function/settings.png"));
